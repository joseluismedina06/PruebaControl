    ...
    <?php
        ...
        //----- var Datos basic
        //  
        $attachments  = basePL::getReq($_REQUEST,"attachments");
        
        if($idpartyenterprise!="" && $urloper!="save"){
            $dbl=new baseBL();
            $com="SELECT attachments FROM core.securityplancomplements WHERE idparty='$idpartyenterprise'";
            // var_dump($com);
            $attachments=$dbl->executeScalar($com);
        }        
        ...
        $registrobl->buildLinks("anexoPL.php",$pn,$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink,$action);    
        $bpl = new basePL("document.anexoPL",$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink);
...
// nowcertifiesdate
            ...
            // }
                ...
                $("#untilcertifies_records").on("change", function() {
                    ...
                    //     var impr="imppdf";
                    //     // alert(iddoc);
                    //     $.post("pdfPL.php", { impr: impr }, function(data) {
                    //         window.print(data);
        ...
        <body>    
            <FORM action="<?php echo $action;?>" method="post" name="anexoPL" class="italsis">
    		<!--Navegacion-->
            <drawer-menu>
            <div align="center">
    ...
    // echo "<div style='display: flex;'>"; 
        ...
        /*
echo '<div style="">
    <!--<span style="color:black; font-size: x-large; ">Anexos</span>-->
    </div>';
    echo '<div align="center">';         
    myPresentationLayer::buildTextAreasInpunClass("Descripcion", "attachments", "attachments", $attachments,"input textarea","title", $rows, $cols);
    echo '</div>';*/
    ...
    echo '<br>';
myPresentationLayer::inputFileImg("ANEXO-0","ANEXO-0","ANEXO-0-".$idpartyenterprise,"ANEXO","show-ANEXO-0-","fa fa-images custom-file-label-icon", "","","img-previewiddocument img-fluid",
    "","","","","");
