    ...
    <html>
        <head>
            ...
            <title>TIPOS DE EMERGENCIAS</title>
    ...
    <?php
        ...
        $emergencytypes  = basePL::getReq($_REQUEST,"emergencytypes");
        $emergencyhurracaine  = basePL::getReq($_REQUEST,"emergencyhurracaine");
        $emergencyflooding  = basePL::getReq($_REQUEST,"emergencyflooding");
...
emergencyflooding 
            ...
            $resul=$dbl->executeReader($com);
                if ($resul[0] != "") { 
  $emergencytypes = $resul[0]["emergencytypes"];
  $emergencyhurracaine = $resul[0]["emergencyhurracaine"];
  $emergencyflooding = $resul[0]["emergencyflooding"];
 ...
 '$emergencytypes' ,
 '$emergencyhurracaine' ,
 '$emergencyflooding'  ) RETURNING id";
                                // var_dump($com);
                            $idsecurityplansubprogram=$dbl->executeScalar($com);
                            if ($idsecurityplansubprogram>0 && $idsecurityplansubprogram!="") {
                                $path = "funcionesdelequipodecombatecontraincendiosPL.php";
 ...
 emergencyhurracaine='$emergencyhurracaine',
 emergencyflooding='$emergencyflooding' 
        ...
        $registrobl->buildLinks("tiposdeemergenciasPL.php",$pn,$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink,$action);    
        $bpl = new basePL("document.tiposdeemergenciasPL",$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink);
...
// nowcertifiesdate
        ...
        <body>    
            <FORM action="<?php echo $action;?>" method="post" name="tiposdeemergenciasPL" class="italsis">
    		<!--Navegacion-->
            <drawer-menu>
            <div align="center">
    ...
    <?php
        ...
        presentationLayer::buildIdInputHidden($id,"document.tiposdeemergenciasPL",$fLink);
        myPresentationLayer::buildInputHidden("idparty","idparty","idparty",$idparty);

        presentationLayer::buildFormTitle('  
    <div data-drawer-open><div style="float:left;"><i class="material-icons">menu</i></div>TIPOS DE EMERGENCIAS</div>
           ',"");    
...
echo '<div style="">
    <!--<span style="color:black; font-size: x-large; ">TIPOS DE EMERGENCIAS</span>-->
    </div>';
           
    myPresentationLayer::buildTextAreasInpunClass($title, "emergencytypes", "emergencytypes", $emergencytypes,"input textarea","title", $rows, $cols);
          
    echo '<br>';

    echo '<div style="">
    <span style="color:black; font-size: x-large; ">Diagrama de Flujo</span>
    </div>'; 
    echo '<br>';
    echo '<div style="">
    ...
    echo '<br>';
myPresentationLayer::inputFileImg("TIPOSEMERG-0","TIPOSEMERG-0","TIPOSEMERG-0-".$idpartyenterprise,"TIPOSEMERG","show-TIPOSEMERG-0-","fa fa-images custom-file-label-icon", "","","img-previewiddocument img-fluid",
    "","","","","");

       
    $com="SELECT * from core.pictures where idparty='$idpartyenterprise'  and name like '%TIPOSEMERG-0-%' and delete='N'";
    $imgs=$dbl->executeReader($com);  


echo '<div class="col-12 col-lg-8" id="show-TIPOSEMERG-0-" style="margin-top:1rem; display: flow-root;">';
    $i=0;
    if($imgs!=""){
        foreach($imgs as $b){            
...
echo '<br>';
    ...
    echo '<br>';
myPresentationLayer::inputFileImg("TIPOSEMERG-1","TIPOSEMERG-1","TIPOSEMERG-1-".$idpartyenterprise,"TIPOSEMERG","show-TIPOSEMERG-1-","fa fa-images custom-file-label-icon", "","","img-previewiddocument img-fluid",
    "","","","","");

       
    $com="SELECT * from core.pictures where idparty='$idpartyenterprise'  and name like '%TIPOSEMERG-1-%' and delete='N'";
    $imgs=$dbl->executeReader($com);  


echo '<div class="col-12 col-lg-8" id="show-TIPOSEMERG-1-" style="margin-top:1rem; display: flow-root;">';
    $i=0;
    if($imgs!=""){
        foreach($imgs as $b){            
            $contentimg=$b["content"]; 
...
echo '<br>';
    ...
    echo '<div style="">
    <span style="color:black; font-size: x-large; ">Hacer en caso de Huracán</span>
    </div>';  
    echo '<br>';   
    myPresentationLayer::buildTextAreasInpunClass($title, "emergencyhurracaine", "emergencyhurracaine", $emergencyhurracaine,"input textarea","title", $rows, $cols);
...
myPresentationLayer::inputFileImg("TIPOSEMERG-2","TIPOSEMERG-2","TIPOSEMERG-2-".$idpartyenterprise,"TIPOSEMERG","show-TIPOSEMERG-2-","fa fa-images custom-file-label-icon", "","","img-previewiddocument img-fluid",
    "","","","","");

       
    $com="SELECT * from core.pictures where idparty='$idpartyenterprise'  and name like '%TIPOSEMERG-2-%' and delete='N'";
    $imgs=$dbl->executeReader($com);  


echo '<div class="col-22 col-lg-8" id="show-TIPOSEMERG-2-" style="margin-top:1rem; display: flow-root;">';
    $i=0;
    if($imgs!=""){
        foreach($imgs as $b){            
            $contentimg=$b["content"]; 
...
echo '<br>';echo '<br>';echo '<br>';
    ...
    echo '<div style="">
    <span style="color:black; font-size: x-large; ">Hacer en caso de Inundación</span>
    </div>'; 
    echo '<br>';
    myPresentationLayer::buildTextAreasInpunClass($title, "emergencyflooding", "emergencyflooding", $emergencyflooding,"input textarea","title", $rows, $cols);
    ...
    echo '<br>';
myPresentationLayer::inputFileImg("TIPOSEMERG-3","TIPOSEMERG-3","TIPOSEMERG-3-".$idpartyenterprise,"TIPOSEMERG","show-TIPOSEMERG-3-","fa fa-images custom-file-label-icon", "","","img-previewiddocument img-fluid",
    "","","","","");

       
    $com="SELECT * from core.pictures where idparty='$idpartyenterprise'  and name like '%TIPOSEMERG-3-%' and delete='N'";
    $imgs=$dbl->executeReader($com);  


echo '<div class="col-32 col-lg-8" id="show-TIPOSEMERG-3-" style="margin-top:1rem; display: flow-root;">';
    $i=0;
    if($imgs!=""){
        foreach($imgs as $b){            
            $contentimg=$b["content"]; 
