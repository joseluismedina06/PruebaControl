    ...
    <html>
        <head>
            ...
            <title>SUBPROGRAMA DE RECUPERACION</title>
    ...
    <?php
        ...
        if ($urloper == "save" && ($msj_error=="" && $error_msg_first_regist=="")) {
                    ...
                    if($msj_error=="" && $error_msg_first_regist==""){
                      ...
                      // var_dump($com);
                            ...
                            if ($idsecurityplancomplements>0 && $idsecurityplancomplements!="") {
                                ...
                                $path1 = "vueltaalanormalidadPL.php";
                            }
                        // }                                          
                    }else{
                          utilities::alert($msj_error.$error_msg_first_regist);
            ...
            // }
            if ($path1=="") {
                                $path = "vueltaalanormalidadPL.php";
                utilities::redirect($path);               
            }
        }
        ...
        $registrobl->buildLinks("subprogramaderecuperacionPL.php",$pn,$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink,$action);    
        $bpl = new basePL("document.subprogramaderecuperacionPL",$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink);
...
// nowcertifiesdate
        ...
        <body>    
            <FORM action="<?php echo $action;?>" method="post" name="subprogramaderecuperacionPL" class="italsis">
    		<!--Navegacion-->
            <drawer-menu>
            <div align="center">
    ...
    <?php
        ...
        presentationLayer::buildIdInputHidden($id,"document.subprogramaderecuperacionPL",$fLink);
    ...
    // echo "<div style='display: flex;'>"; 
        ...
        //             
    echo '<div style="">
    <!--<span style="color:black; font-size: large; ">SUBPROGRAMA DE RECUPERACION</span>-->
    </div>';        
        //      
