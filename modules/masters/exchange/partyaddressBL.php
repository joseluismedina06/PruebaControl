    ...
    // $this->deleted  = $deleted; 
          ...
          function validate() {
                ...
                $msg = "";
                    ...
                    if (!utilities::valOk($this->idaddresstypefiscaladdress)) {
                        $valid = false;
                          $msg .= "El dato tipo de direccion, ";
                    } // validate idcity                        
        ...
        function executeaddress($urloper="",$parAr=""){
			...
			if ($urloper == "update") {
				...
				if ($nerr === true) 
					...
					$msg = "Direccion Actualizacion ok. "; 
				else
					$msg = "Direccion Actualizacion Fallida. "; 
//				utilities::alert($msg);
			} // update
         ...
         // var_dump("mmm-->".$nerr);
				if ($nerr === true) {
                                        $msg = "Direccion Registro ok. "; 
                                       //$_SESSION["mensaje"]=$msg;
//					$msg = "Insert Operation OK. ";
				}else{
                                        $msg = "Direccion Registro Fallida. "; 
                                      //  $_SESSION["mensaje"]=$msg;                                    
