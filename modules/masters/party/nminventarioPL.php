        ...
        if ($savesecurityplanriskanalysysemerncyresources=="savesecurityplanriskanalysysemerncyresources" ) {
            ...
            if ($idsecurityplanriskanalysysemerncyresources=="") {
                ...
                if ($idsecurityplanriskanalysysemerncyresources!="") {
                    ...
                    utilities::alert("Error al registrar el Inventario de Materiales para Emergencias");
                }
            }else{
    ...
    ?>
        ...
        <body>    
            <FORM action="<?php //echo $action;?>" method="post" name="nminventarioPL" class="italsis">
            <!--Navegacion-->
            <drawer-menu>
            <div align="center">
    ...
    <?php
        ...
        presentationLayer::buildIdInputHidden($id,"document.nminventarioPL",$fLink);
        ...
        <i class="material-icons">menu</i></div>INVENTARIOS</div>
            ',"");     
