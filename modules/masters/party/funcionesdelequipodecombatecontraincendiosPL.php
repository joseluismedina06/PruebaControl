    ...
    <html>
        <head>
            ...
            <title>FUNCIONES DEL EQUIPO DE COMBATE CONTRA INCENDIOS</title>
    ...
    <?php
        ...
        //----- var Datos basic
        //  
        $teamantifirefunctions  = basePL::getReq($_REQUEST,"teamantifirefunctions");
        
        if($idpartyenterprise!="" && $urloper!="save"){
            $dbl=new baseBL();
            $com="SELECT teamantifirefunctions FROM core.securityplancomplements WHERE idparty='$idpartyenterprise'";
            // var_dump($com);
            $teamantifirefunctions=$dbl->executeScalar($com);
        }        
        ...
        if($idpartyenterprise==""){
            ...
            // if ($urloper == "save" && $teamantifirefunctions=="") {
        ...
        if ($urloper == "save" && ($msj_error=="" && $error_msg_first_regist=="")) {
             $dbl=new baseBL();
                    if($msj_error=="" && $error_msg_first_regist==""){
                        ...
                        if($res==""){
                          ...
                          (idparty,teamantifirefunctions)
                          VALUES ('$idpartyenterprise','$teamantifirefunctions') RETURNING id";
                            $idsecurityplancomplements=$dbl->executeScalar($com);
                            // var_dump($com);                            
                        }else{                        
                            $com="UPDATE core.securityplancomplements 
                            SET teamantifirefunctions='$teamantifirefunctions' WHERE idparty='$idpartyenterprise' RETURNING id";
                      // var_dump($com);
                            $idsecurityplancomplements=$dbl->executeScalar($com);
                            // var_dump($com);
                        }
                            if ($idsecurityplancomplements>0 && $idsecurityplancomplements!="") {
                                ...
                                $path1 = "subprogramaderecuperacionPL.php";
                            }
                        // }                                          
                    }else{
                          utilities::alert($msj_error.$error_msg_first_regist);
            ...
            // }
            if ($path1=="") {
                                $path = "subprogramaderecuperacionPL.php";
                utilities::redirect($path);               
            }
        }
        ...
        $registrobl->buildLinks("funcionesdelequipodecombatecontraincendiosPL.php",$pn,$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink,$action);    
        $bpl = new basePL("document.funcionesdelequipodecombatecontraincendiosPL",$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink);
...
// nowcertifiesdate
        ...
        <body>    
            <FORM action="<?php echo $action;?>" method="post" name="funcionesdelequipodecombatecontraincendiosPL" class="italsis">
    		<!--Navegacion-->
            <drawer-menu>
            <div align="center">
    ...
    <?php
        ...
        presentationLayer::buildIdInputHidden($id,"document.funcionesdelequipodecombatecontraincendiosPL",$fLink);
        myPresentationLayer::buildInputHidden("idparty","idparty","idparty",$idparty);
        
        presentationLayer::buildFormTitle('  
    <div data-drawer-open><div style="float:left;"><i class="material-icons">menu</i></div>FUNCIONES DEL EQUIPO DE COMBATE CONTRA INCENDIOS</div>
           ',""); 
    ...
    // echo "<div style='display: flex;'>"; 
        ...
        //             
    echo '<div style="">
    <!--<span style="color:black; font-size: large; ">FUNCIONES DEL EQUIPO DE COMBATE CONTRA INCENDIOS</span>-->
    </div>';        
        //   
    echo '<div align="center">';          
    myPresentationLayer::buildTextAreasInpunClass($title, "teamantifirefunctions", "teamantifirefunctions", $teamantifirefunctions,"input textarea","title", $rows, $cols);
    echo '</div>';        
