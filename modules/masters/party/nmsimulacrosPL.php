    ...
    <?php
        ...
        if($idpartyenterprise!="" && $simulationexercise==""){
            $dbl=new baseBL();
            ...
            if($msj_error=="" && $error_msg_first_regist==""){
                ...
                if ($idsecurityplancomplements=="") {
                    ...
                    if ($idsecurityplancomplements>0 && $idsecurityplancomplements!="") {
                        $path = "nmsubprogramadeauxilioPL.php";
        ...
        $registrobl->buildLinks("nmsimulacrosPL.php",$pn,$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink,$action);    
        $bpl = new basePL("document.nmsimulacrosPL",$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink);
    ...
    <?php
        ...
        presentationLayer::buildIdInputHidden($id,"document.nmsimulacrosPL",$fLink);
        myPresentationLayer::buildInputHidden("idparty","idparty","idparty",$idparty);

        presentationLayer::buildFormTitle('  
        <div data-drawer-open><div style="float:left;"><i class="material-icons">menu</i></div>SIMULACROS</div>
            ',"");     
        ...
        echo '<br>';    
        myPresentationLayer::inputFileImg("SIMULATIO-0","SIMULATIO-0","SIMULATIO-0-".$idpartyenterprise,"SIMULATIO","show-SIMULATIO-0-","fa fa-images custom-file-label-icon", "","","img-previewiddocument img-fluid",
        "","","","","");
