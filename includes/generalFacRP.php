<?php
	...
	class generalFacRP extends PDFitalsis {
		...
		function Header() {
			...
			if ($this->PageNo() == 1) {
				...
				$this->setY(15);
				$this->setX(5);
				$this->MultiCell(200,5,$this->infol0,0,'C');
				$this->setY(20);
				$this->setX(5);
				$this->MultiCell(200,5,$this->infol1,0);
				$this->setY(25);
				$this->setX(5);
				$this->MultiCell(200,5,$this->infol2,0);
				$this->setY(30);
				$this->setX(5);
				$this->MultiCell(200,3,$this->infol3,0);
				$this->setY(35);
				$this->setX(5);
		...
		function Footer()
		{
			$this->SetY(-15);
       	 	...
       	 	function report($dl,$file,$fileLink,$com,$tit="",$infol0 = "", $infol1 = "", $infol2 = "", $infol3 = "",
		...
		function reportArray($file,$fileLink,$res,$tit="",$infol0 = "",$infol1 = "", $infol2 = "", $infol3 = "",
