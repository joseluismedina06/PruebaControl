    ...
    <?php
        ...
        if($idpartyenterprise!="" && $helpsubprogram==""){
            $dbl=new baseBL();
    ...
    ?>
        ...
        <body>    
            <FORM action="<?php //echo $action;?>" method="post" name="nmsubprogramadeauxilioPL" class="italsis">
            <!--Navegacion-->
            <drawer-menu>
            <div align="center">
    ...
    <?php
        ...
        presentationLayer::buildIdInputHidden($id,"document.nmsubprogramadeauxilioPL",$fLink);
