...
// nowcertifiesdate
    ...
    //<span style="color:black; font-size: x-large; ">MARCO LEGAL</span>
    //</div>'; 
    
    presentationLayer::buildFormTitle('  
    <div data-drawer-open><div style="float:left;"><i class="material-icons">menu</i></div>MARCO LEGAL</div>
           ',"");     

           echo '<div align=center>';       
    myPresentationLayer::buildTextAreasInpunClass($title, "legalframework", "legalframework", $legalframework,"input textarea","title", $rows, $cols);
    echo '</div>';        
