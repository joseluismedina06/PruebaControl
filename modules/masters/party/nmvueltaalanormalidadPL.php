    ...
    <?php
        ...
        if($idpartyenterprise!="" && $cometonormal==""){
            $dbl=new baseBL();
        ...
        $registrobl->buildLinks("nmvueltaalanormalidadPL.php",$pn,$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink,$action);    
        $bpl = new basePL("document.nmvueltaalanormalidadPL",$sLink,$dLink,$pLink,$cLink,$fLink,$fbnLink);
    ...
    <?php
        ...
        presentationLayer::buildIdInputHidden($id,"document.nmvueltaalanormalidadPL",$fLink);
        ...
        echo '<br>';    
        myPresentationLayer::inputFileImg("COMETONORMAL-0","COMETONORMAL-0","COMETONORMAL-0-".$idpartyenterprise,"COMETONORMAL","show-COMETONORMAL-0-","fa fa-images custom-file-label-icon", "","","img-previewiddocument img-fluid",
        "","","","","");
