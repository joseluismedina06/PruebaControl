    ...
    <html>
        <head>
            ...
            <title>SubPrograma de Prevención</title>
    ...
    <?php
        ...
        */
        ...
        if($idpartyenterprise==""){
            ...
            $msj_error .= "Hay problemas con la información de la empresa. Verifique";                
        }else{
        ...
        if ($urloper == "save" && ($msj_error=="" && $error_msg_first_regist=="")) {
            ...
            if($msj_error=="" && $error_msg_first_regist==""){
                ...
                if ($idsecurityplansubprogram=="") {
                    ...
                    $com="INSERT INTO core.securityplansubprogram 
                        (idparty,info) VALUES ('$idpartyenterprise','$info') RETURNING id";
                    // var_dump($com);
                    $idsecurityplansubprogram=$dbl->executeScalar($com);
                    if ($idsecurityplansubprogram>0 && $idsecurityplansubprogram!="") {
                        $path = "nmorganizacionPL.php";
...
// -----------------------------------
    ...
    <?php
        ...
        presentationLayer::buildFormTitle('  
            ...
            <i class="material-icons">menu</i></div>SUBPROGRAMA DE PREVENCIÓN</div>
           ',"");  
        ...
        myPresentationLayer::buildTextAreasInpunClassAndStyle(
            $title, "info", "info", $info,"input textarea","title", $rows, $cols,"width:80%");
        ...
        echo '<br>';
        myPresentationLayer::buildTextAreasInpunClassAndStyle($title, "infoorganizationchart", "infoorganizationchart", $infoorganizationchart,"input textarea2","title", $rows, $cols,"width:80%");
        echo '<br>';
